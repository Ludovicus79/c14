                ...
                <form class="form-horizontal" role="form" method="POST" action="" onsubmit="showLoading()">
                    ...
                    <div class="row">
                        <div class="col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
                            ...
                            <!--ITERATIVA-->
                    <div class="form-group row">
                       <label class="col-xs-4 col-sm-offset-2 col-sm-3 control-label"><?php echo trans('applicationResource.form.minimoLabel'); ?></label>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\c14-main\resources\views/search/byShiftNoPosition.blade.php ENDPATH**/ ?>