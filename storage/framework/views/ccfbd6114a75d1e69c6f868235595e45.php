...
<head>
    <meta charset="UTF-8">
    <title>3D Molecule - <?php echo e($molecule->name ?? 'Molecule'); ?></title>
...
<body>
    ...
    <div class="header">
        <div class="header-content">
            <h1><?php echo e($molecule->name ?? 'Molecule'); ?></h1>
        </div>
        ...
        <div class="info-sidebar">
            <div class="info-card">
                ...
                <div class="stat-row">
                    ...
                    <span class="stat-value"><?php echo e($molecule->name ?? '-'); ?></span>
                </div>
                <div class="stat-row">
                    <span class="stat-label">Formula</span>
                    <span class="stat-value"><?php echo e($molecule->molecularFormula ?? '-'); ?></span>
                </div>
                <div class="stat-row">
                    <span class="stat-label">Molecular Weight</span>
                    <span class="stat-value"><?php echo e($molecule->molecularWeight ?? '-'); ?></span>
                </div>
                <div class="stat-row">
                    <span class="stat-label">Database ID</span>
                    <span class="stat-value">#<?php echo e($molecule->id ?? '-'); ?></span>
                </div>
                <div class="stat-row">
    ...
    <script>
        ...
        var smilesData = "<?php echo e($molecule->smiles ?? ''); ?>";
        var molData = <?php echo json_encode($molecule->mol ?? null, 15, 512) ?>;
...
</html><?php /**PATH /Users/usuario/Downloads/C14-CORREGIDO/C14-main-2/resources/views/search/molecule3d.blade.php ENDPATH**/ ?>