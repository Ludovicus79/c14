    ...
    <div class="container">
        <div class="header">
            <div>
                ...
                <div class="meta">
                    <?php if(isset($molecule->molecularFormula)): ?>
                    <span><strong>Formula:</strong> <?php echo e($molecule->molecularFormula); ?></span>
                    <?php endif; ?>
                    <?php if(isset($molecule->molecularWeight)): ?>
                    <span><strong>MW:</strong> <?php echo e($molecule->molecularWeight); ?></span>
                    <?php endif; ?>
                </div>
            </div>
