...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('jsme/JSME_2024-04-29/jsme/jsme.nocache.js')); ?>"></script>
    <script>
        var jsmeApplet;
        function jsmeOnLoad() {
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-8 substructure-controls">
                            <div class="form-group row text-center">
                                <label class="col-xs-5 control-label"><?php echo trans('applicationResource.form.stereo'); ?></label>
                                <div class="col-xs-1">
                                    <div class="btn-group" data-toggle="buttons">
                                        <label class="btn btn-danger <?php echo e(old('stereo') ? 'active' : ''); ?>" id="stereoButton">
                                            <input type="checkbox" name="stereo" value="1" <?php echo e(old('stereo') ? 'checked' : ''); ?>>
