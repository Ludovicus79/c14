...
<head>
   <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    ...
    <link rel="stylesheet" href="{{ asset('css/responsive.css') }}">   <!-- añadir esta -->
    ...
    <div class="row" id="barraSup">
        <div class="col-md-3 col-xs-12 text-center">
            <ul class="list-inline">
                <li>
                    <a href="{!! route('lang.switch', ['lang' => 'es']) !!}">
...
<footer class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-3 col-md-4 text-center text-white vcenter">
            ...
            <a href="/cdn-cgi/l/email-protection#5f33302f3a251f2a2c3e33713a2c"><span class="__cf_email__" data-cfemail="771b18071